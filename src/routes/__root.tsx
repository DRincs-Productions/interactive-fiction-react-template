        ...
        <>
            <RootProvider>
                ...
                <div className="flex h-full w-full flex-col items-center">
                    <div className="relative flex h-full w-full flex-1 flex-col overflow-y-auto bg-background px-6 text-foreground sm:max-w-3xl sm:border-x sm:border-border sm:px-10">
                        <Outlet />
                    </div>
                </div>
            </RootProvider>
